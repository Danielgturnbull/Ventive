/*
    @ Copyright © 2021 point-web.fr

/************ var ************/

var DEV = typeof noloader !== 'undefined' ? noloader : true,
...
function $afterLoad() {
    ...
    if ($html.data('load') != true) {
        ...
        if ($('.bt').length) {
            $('.bt').each(function () {
                $g.from(this, 1.5, {
                    autoAlpha: 0, ease: exo, scrollTrigger: {
                        trigger: this,
                        start: "top 95%"
                    }
                });
        ...
        if ($('#eu').length) {
            ...
            $gs.batch('.hspan > span > span', {
                onEnter: function (batch) {
                    $g.to(batch, 1.3, {y: '0%', ease: exo, stagger: {each: .2}})
                }
            });
        ...
        // var $fo = $g.timeline({scrollTrigger:{
        //     trigger: '#f',
        //     start:'top bottom'
        // }});
        // $fo.staggerFrom('#f .ct > *', 2, {y: '100%', autoAlpha: 0, ease: exo}, .2);
        ...
        if ($('#sc').length) {
            ...
            $gs.batch('#sc .p > *, #sc h3, #sc h4, [data-projet-id]', {
                onEnter: function (batch) {
                    $g.to(batch, 1.5, {opacity: 1, y: 0, ease: exo, stagger: {each: .2}}, 'a')
                }
            });
        ...
        if ($('.ec').length) {
            ...
            if ($win.width() > $res) {
                ...
                $g.fromTo('.mck-2 .m2', 1, {y: '-10%', x: '-20%'}, {
                    y: '20%', x: '10%', scrollTrigger: {
                        trigger: ".mck-2",
                        start: "left right",
                        scrub: true
                    }
                ...
                $gs.batch('.p > *, .txt, .list-s > *, .ec .ima, .ec .btec', {
                    onEnter: function (batch) {
                        $g.to(batch, 1.3, {y: 0, opacity: 1, ease: exo, stagger: {each: .2}})
                    }
                });
                ...
                $('.lgs').each(function () {
                    var $tl = $g.timeline();
                    $tl.staggerFromTo($(this).find('.ima'), 1, {left: 150}, {
                        left: -150, scrollTrigger: {
                            trigger: this,
                            start: "left right",
                            end: "right left",
                            scrub: true
                ...
                $('.chif > div').each(function () {
                    ...
                    $tl.to($t.find('svg'), 2, {
                        strokeDasharray: '300 999', onStart: function () {
                            var Cont = {val: $nmin}, NewVal = $nmax;
                            var $tc = $g.timeline({paused: true});
                            $tc.to(Cont, 3, {
                                val: NewVal, ease: exo, roundProps: "val", onUpdate: function () {
                ...
                $('.lgs').each(function () {
                    var $tl = $g.timeline();
                    $tl.staggerFromTo($(this).find('.ima'), 1, {top: 150}, {
                        top: 0, scrollTrigger: {
                            trigger: this,
                            start: "top bottom",
                            end: "bottom top",
        ...
        if ($('#map').length) {
            ...
            $g.to('.mapboxgl-canvas-container', 1, {
                top: '25%', opacity: 0, scrollTrigger: {
                    trigger: "#cnt",
                    start: "top top",
                    end: "bottom top",
                    scrub: true
...
$('[data-etude]').on('click', function (e) {
    ...
    $tl.to($t.find('.bg'), 1, {
        ease: exi, height: '100%', y: '0%', onComplete: function () {
...
$('[data-close-etude]').on('click', function (e) {
    ...
    if ($win.width() > $res) {
        ...
        $tl.to('#app', 1, {
            ease: exi, y: '100%', onComplete: function () {
                document.location.href = $h;
            }
        }, 'a');
    } else {
        ...
        $tl.to('#app', 1, {
            ease: exi, x: '100%', onComplete: function () {
                document.location.href = $h;
            }
        }, 'a');
    }
...
$('[data-part-n]').each(function () {
    ...
    $cof_a[$n].fromTo('#cof .t' + $n, 1, {y: '105%'}, {
        y: '0%', ease: Power1.easeInOut, onStart: function () {
...
// $s.setPosition(sessionStorage.getItem('x'), sessionStorage.getItem('y'));
